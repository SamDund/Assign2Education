...
R1 <- lm(PercentIntention ~ PercentPerceived + PercentFear*PercentOpportunities + WayofTeach + Country, data = CompleteData)

# Obtain summary statistics of R1
summary(R1)

# Run linear regression R2
R2 <- lm(PercentNascent ~ PercentPerceived + PercentFear*PercentOpportunities + WayofTeach + Country, data = CompleteData)
...
R3 <- lm(PercentOwner ~ PercentPerceived + PercentFear*PercentOpportunities + WayofTeach + Country, data = CompleteData)
...
labels <- c('National Level Avg Perceived Capabilities', 'National Level Avg Fear of Failure',
            'National Level Avg Perceived Good Opportunities', 'Way of Teaching', 'Austria',
            'Belgium', 'Canada', 'Chile', 'Czech Republic', 'Denmark', 'Finland', 'France',
            'Germany', 'Greece', 'Hungary', 'Iceland', 'Ireland', 'Israel', 'Italy', 'Japan',
            'Korea (South)', 'Mexico', 'Netherlands', 'New Zealand', 'Norway', 'Poland',
            'Portugal', 'Slovenia', 'Spain', 'Sweden', 'Switzerland', 'Turkey',
            'United Kingdom','United States', 'National Level Avg Fear of Failure x National Level Avg Perceived Good Opportunities', '(Intercept)')
...
Z1 <- zelig(PercentIntention ~ PercentPerceived + PercentFear*PercentOpportunities + WayofTeach, data = CompleteData_omit, model = "ls")
...
H1 <- hist(CompleteData$PercentPerceived)
