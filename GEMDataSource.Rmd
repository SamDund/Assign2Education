...
# Import GEM supportive teaching data as a proxy for how favourable to self-confidence a given education system is
...
To review, the three regression equations used for this assignment are included below.


1. $PercentIntention = PercentPerceived(Perceived Capabilities) + GEM D01 way of teaching + PercentOpportunities(Perceived Opportunities)$  
