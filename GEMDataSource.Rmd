...
Next steps will also include looking more thoroughly into control variables. To do so we may need to extract data from various national NES reports and put together a table, as it does not seem to exist as such.
