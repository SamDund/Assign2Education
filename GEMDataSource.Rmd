...
R2 <- lm(PercentNascent ~ PercentPerceived + PercentFear + AnnualGDPGrowth + 
           PercentOpportunities, data = CompleteDataset)
>>>>>>> d492a8dcde27e8a4480f0504d410e52e7c2d7e6e
summary(R2)
...
labels <- c('(Intercept)', 'Percent Perceived', 'Percent Fear',
            'Annual GDP Growth', 'Percent Opportunities')

stargazer::stargazer(R1, R2, R3, covariate.lables = labels, title = 'Linear Regression Estimates', digits = 2, type = 'html')
