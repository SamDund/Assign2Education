...
R1 <- lm(PercentIntention ~ PercentPerceived + PercentFear + AnnualGDPGrowth + 
           PercentOpportunities, data = CompleteDataset)
summary(R1)
...
# Run a linear regression
R2 <- lm(PercentNascent ~ PercentPerceived + PercentFear + AnnualGDPGrowth, data = CompleteDataset)

R2 <- lm(PercentNascent ~ PercentPerceived + PercentFear + AnnualGDPGrowth + 
           PercentOpportunities, data = CompleteDataset)
...
# Run a linear regression
R3 <- lm(PercentOwner ~ PercentPerceived + PercentFear + AnnualGDPGrowth, data = CompleteDataset)

R3 <- lm(PercentOwner ~ PercentPerceived + PercentFear + AnnualGDPGrowth + 
           PercentOpportunities, data = CompleteDataset)
...
labels <- c('Percent Perceived', 'Percent Fear',
            'Annual GDP Growth', 'Percent Opportunities', '(Intercept)')
