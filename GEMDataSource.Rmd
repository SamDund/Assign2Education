...
SupportiveTeaching <- repmis::source_data("https://https://raw.githubusercontent.com/SamDund/Assign2Education/master/GEMData/NES2010CSV/2010GEMNES-Table%201.csv", header = TRUE, cache = FALSE)
...
```{r echo = FALSE, cache=TRUE, include=TRUE, results='asis', warning=FALSE}
library(xtable)
Table1 <- xtable(summary(CompleteDataset))
xtable(CompleteDataset, type = 'html')

library(stargazer)
stargazer(CompleteDataset, column.sep.width = "20pt", type = 'html')
