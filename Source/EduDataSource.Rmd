...
########## Recode Country Names in Annual GEM NES Datasets ##########
...
########## Subset Annual GEM NES Datasets ##########
...
S1 <- subset_data$names <- NULL


########## Change Column names in Subset Annual GEM NES Dataset ##########
