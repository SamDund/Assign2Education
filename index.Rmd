...
Our original intention was to conduct a country- the relationship between the way of teaching and the rate of entrepreneurship in each OECD country.  To do so, we should run a fixed effects regression for each country.  When doing so, however, we find that our explanatory variable has a negative coefficient and our regression equation contains a negative slope.  This may be due to a lack of available data, a flawed survey method, or inaccurate expectations.  
