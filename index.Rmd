...
Z1 <- zelig(PercentIntention ~ WayofTeaching + PercentPerceived + PercentFear*PercentOpportunities + PercentOpportunities, data = CD_omit, model = "ls")
...
# Set working directory to local repository
setwd('~/Assign2Education/')

# Open csv
Cimputed <- read.table("Cimputed5.csv", header = TRUE, sep = ",", na.strings = NA)

# Regression equation with imputed values
Z2 <- zelig(PercentIntention ~ WayofTeaching + PercentPerceived + PercentFear*PercentOpportunities + PercentOpportunities + Country, data = Cimputed, model = "ls")
```
