...
Z1 <- zelig(PercentIntention ~ WayofTeaching + PercentPerceived + PercentFear*PercentOpportunities + PercentOpportunities, data = CD_omitted, model = "ls")
...
Z2 <- zelig(PercentIntention ~ WayofTeaching + PercentPerceived + PercentFear*PercentOpportunities + PercentOpportunities, data = CI_omitted, model = "ls")
...
par(mfrow = c(1, 2))
plot(simz1, xlab = 'Percent Perceived Opportunities', ylab = 'Percent Entrepreneurial Intention', main = "Unimputed")
plot(simz2, xlab = 'Percent Perceived Opportunities', ylab = 'Percent Entrepreneurial Intention', main = "Imputed")
