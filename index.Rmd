...
We have included our findings in a detailed paper available [here](https://github.com/SamDund/Assign2Education/tree/master/PresentationandPaper).  In sum, however, the most statistically significant and important findings from our analysis are that there is some evidence of a postitive relationship between higher levels of self-confidence reinforcement in teaching (a higher "WayofTeaching" score) and the rate of people owning their own business.  This can be seen in the chart below.  For example, in the case of the United States and the United Kingdom, the country-specific trend appears to have a decreasing slope.  We believe this may be due to inconsistency in the survey and that a larger data set would allow us to more accurately describe the relationship between these variables.
