...
CD2 <- melt(data = CD,
                  ...
                  measure.vars = c("WayofTeaching", "PercentFear", "PercentNascent", "PercentPerceived",
                                   "PercentOwner", "PercentIntention", "PercentOpportunities"))


names(CD2) <- gsub("variable", "Survey Question", names(CD2))
names(CD2) <- gsub("value", "Response", names(CD2))    
