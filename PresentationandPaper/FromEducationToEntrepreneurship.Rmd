...
The entrepreneurship culture of a given area or population (The OECD refers partially to the Global Entrepreneurship Monitor or GEM data).  
...
Now, since self-confidence is considered to rely partly on one's integration within social networks [@OECD2009] we should ideally be looking into the collectivism or individualism at play across education systems, the more so as there is visibly something at stake on that side too as this table shows :  
...
Here, when we mention that an education system reinforces self-confidence, we mean that teachers use positive reinforcement when interacting with students. This entails providing feedback that will help the students maintain their level of motivation as well as their level of self-esteem. This also entails supporting students' taking initiatives, encouraging creativity will also be part of this self-confidence reinforcement.  


The support of students' self-confidence within education systems as we just defined it can also affect the students' entrepreneurial self-efficacy, which should be controled for. Which we will do by looking into average perceived entrepreneurial capabilities and fear of failure  

indeed an effective explanatory variable, we will need to control for the entrepreneurial self-efficacy




Ideally we would have also liked to add the social dimension to it, meaning that students that are socially included may have a slightly higher degree of self-confidence, as we saw suggested in the literature.
