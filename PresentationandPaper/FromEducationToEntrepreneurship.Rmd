...
Additional information on the GEM data used for this research can be seen in the descriptive statistics table included below.  
...
Given our data characteristics and the available models in the Zelig package, we used a "Least Squares Regression for Continuous Dependent Variables." A regression output table and our simulation results are included below.  
