...
###Research Question  
Drawing a comparison between Portugal, Sweden, France, and Britain, to what extent do the behavioural characteristics of the education system - individualistic, group-oriented, or focused on positive reinforcement - affect the rate of entrepreneurship in each country?

###Research Justification
Often, when it comes to public budgeting for education policies, the decision process does not appear to be rational, it does not seem to take into account the return on investment that should be expected in the long run. Still many claims have been made in the literature that start-up and entrepreneurship activities at a country-level are affected by factors other than structural and economic, that is cultural or educational. However only a few empirical studies have actually been carried out and most of them focused on which attitudes were favourable to starting a business, almost none explored how cultural patterns affected these dispositions.  

When cultural factors are looked at, they are considered as a given feature that can hardly be traced. By having a closer look at education systems, we intend to look at the processes through which some of these cultural patterns are enhanced and passed from one generation to the next. Aside of parental education, schools are indeed the very place where children are taught how to fit in the society. This research is an attempt at looking at one trait in particular that is self-confidence.
...
####Estimation Strategy  
The estimation strategy will consist of using cross-sectional data about Portugal, Sweden, France and Britain at different points in time regarding the sense of belonging to a group, self-confidence patterns and the entrepreneurship features of each country.
