...
- This figure is a national-level precentage


- This measure was chosen to provide some insight on how personal values are shaped, especially in terms of self-confidence.


## Differences in Perceived Capability in OECD Countries
...
## Time Variation in Perceived Capabilities
```{r echo =FALSE, cache=TRUE, include=FALSE, results='asis', warning=FALSE, error=FALSE, message=FALSE}
library("ggplot2")
library("reshape2")
...
- Since we look at average individual self-esteem in every OECD country, we believe it is appropriate to look at the opportunities perceived by the average 18-64-year-old individual in these countries.
...
- We decided to do this because the coefficients do not change signficantly when the country-specific effects are ignored.
